...
/**
* @param {any} commits_value
* @param {any} pre_lines_value
* @param {any} chains_value
* @returns {any}
*/
module.exports.attach_graph = function(commits_value, pre_lines_value, chains_value) {
    const ret = wasm.attach_graph(addHeapObject(commits_value), addHeapObject(pre_lines_value), addHeapObject(chains_value));
...
module.exports.__wbg_alert_ddf4cfd5036c38ff = function(arg0, arg1) {
...
module.exports.__wbg_get_2268d91a19a98b92 = function(arg0, arg1) {
...
const path = require('path').join(__dirname, 'git_graph_bg.wasm');
